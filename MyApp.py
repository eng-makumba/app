...
class MyApp(App):
    def build(self):
        ...
        self.label = Label(text="Remote Information", size_hint_y=0.1)
        sms_button = Button(text="Display SMS Messages", on_press=self.display_messages, size_hint_y=0.1)
        contact_button = Button(text="Display Contacts", on_press=self.display_contacts, size_hint_y=0.1)
        email_button = Button(text="Send Email", on_press=self.send_email, size_hint_y=0.1)
